...
<tr>
  ...
  <td><input type="text" name="custom_logo_url" class="ss_text" value="<?php echo stripslashes(stripslashes(get_option($shortname.'_custom_logo_url',''))); ?>" /><br /><small><a href="<?php bloginfo('url'); ?>/wp-admin/media-new.php" target="_blank">Upload your logo</a> (example:980px wide x 300px high)</small></td>
</tr>
<tr>
...
<tr>
  <td>Linkedin Link:</td>
  <td><input type="text" name="tumblr_link" class="ss_text" value="<?php echo stripslashes(stripslashes(get_option($shortname.'_tumblr_link',''))); ?>" /></td>
</tr>
