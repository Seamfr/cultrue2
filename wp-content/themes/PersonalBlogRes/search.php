			...
			<div id="posts_cont">
				...
				while (have_posts()) : the_post(); ?>     
					<div class="post_box">
							...
							<?php } ?>				
							<a href="<?php the_permalink(); ?>"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/view-more.png" alt="view more" class="view_more" /></a>
							</div><!--//media_cont-->
							<p><?php echo ds_get_excerpt('320'); ?></p>
						<div class="clear"></div>
					</div><!--//post_box-->
				<?php $x++; ?>
				<?php endwhile; ?>
